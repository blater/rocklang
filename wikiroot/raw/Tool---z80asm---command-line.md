...
(e.g. `@project.lst`). The list file contains input file names, project lists 
prefixed with an at-sign (which are opened recursively) or assembler options
separated by spaces or newlines.  
Hash signs (`#`) and semi-colons (`;`) cause the rest of the line to be ignored
and can be used to include comments.
...
|-mr4k     |Rabbit 4000
|-mr5k     |Rabbit 5000
|-mkc160   |KC160 with segments |
|-mkc160_z80 | KC160 in 16-bit mode |
|-mti83plus|TI83Plus
|-mti83    |TI83
