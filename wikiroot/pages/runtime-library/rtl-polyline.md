...
Thin wrapper over [[rtl-draw]]. `polyline(xs, ys)` takes two parallel
...
- [[rtl-draw]] — the line primitive polyline delegates to
- [[rtl-plot]] — the pixel primitive underpinning both
