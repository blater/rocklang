...
int main(int argc, char **argv) {
  ...
  {
    byte b = 65;
    print(new_string(__rock_make_string("byte value: ", 12)));
    print(to_string(b));
    ...
    print(new_string(__rock_make_string("\n", 1)));
    byte b2 = to_byte(200);
    print(new_string(__rock_make_string("to_byte(200): ", 14)));
    print(to_string(b2));
    print(new_string(__rock_make_string("\n", 1)));
    byte b3 = to_byte(300);
    print(new_string(__rock_make_string("to_byte(300) truncated: ", 24)));
    print(to_string(b3));
    print(new_string(__rock_make_string("\n", 1)));
    int sum = to_int(b) + to_int(b2);
    print(new_string(__rock_make_string("65 + 200 = ", 11)));
    print(to_string(sum));
    print(new_string(__rock_make_string("\n", 1)));
    __internal_dynamic_array_t arr = __internal_make_array(sizeof(byte), 0);
    byte_push_array(arr, to_byte(10));
    byte_push_array(arr, to_byte(20));
    byte_push_array(arr, to_byte(30));
    print(new_string(__rock_make_string("array length: ", 14)));
    print(to_string(length(arr)));
    print(new_string(__rock_make_string("\n", 1)));
    print(new_string(__rock_make_string("arr[1] = ", 9)));
    print(to_string(to_int(byte_get_elem(arr, 1))));
    print(new_string(__rock_make_string("\n", 1)));
    int i = 42;
