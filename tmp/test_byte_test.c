...
int main(int argc, char **argv) {
  ...
  {
    byte b = 65;
    print(new_string((string){.data = "byte value: ", .length = 12}));
    print(to_string(b));
    ...
    print(new_string((string){.data = "\n", .length = 1}));
    byte b2 = to_byte(200);
    print(new_string((string){.data = "to_byte(200): ", .length = 14}));
    print(to_string(b2));
    print(new_string((string){.data = "\n", .length = 1}));
    byte b3 = to_byte(300);
    print(
        new_string((string){.data = "to_byte(300) truncated: ", .length = 24}));
    print(to_string(b3));
    print(new_string((string){.data = "\n", .length = 1}));
    int sum = to_int(b) + to_int(b2);
    print(new_string((string){.data = "65 + 200 = ", .length = 11}));
    print(to_string(sum));
    print(new_string((string){.data = "\n", .length = 1}));
