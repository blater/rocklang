...
int main(int argc, char **argv) {
  ...
  {
    print(new_string(
        (string){.data = "=== Advanced Byte Type Tests ===\n", .length = 33}));
    print(new_string((string){.data = "\n--- Test 1: Mixed Arithmetic ---\n",
                              .length = 34}));
    byte b1 = to_byte(10);
    int i1 = 20;
    int result = to_int(b1) + i1;
    print(new_string((string){.data = "to_int(10) + 20 = ", .length = 18}));
    print(to_string(result));
    print(new_string((string){.data = "\n", .length = 1}));
    byte b2 = to_byte(50);
    int result2 = to_int(b2) * 2;
    print(new_string((string){.data = "to_int(50) * 2 = ", .length = 17}));
    ...
    int i4 = to_int(b4);
    if (i3 > i4) {
      print(new_string((string){.data = "100 > 50: true\n", .length = 15}));
    } else {
      print(new_string((string){.data = "100 > 50: false\n", .length = 16}));
    }
    if (i4 < i3) {
      print(new_string((string){.data = "50 < 100: true\n", .length = 15}));
    } else {
      print(new_string((string){.data = "50 < 100: false\n", .length = 16}));
    }
    print(new_string(
                 ...
                 .length = 43}));
    {
      for (int i = 0; i <= (int)4; i++) {
        byte b = to_byte(i * 10);
        print(new_string((string){.data = "i=", .length = 2}));
        print(to_string(i));
        print(new_string((string){.data = ", b=", .length = 4}));
        print(to_string(b));
        print(new_string((string){.data = "\n", .length = 1}));
      };
    }
    ...
    print(new_string((string){.data = "Array: ", .length = 7}));
    {
    ...
    print(new_string((string){.data = "Sum of array: ", .length = 14}));
    print(to_string(sum));
    print(new_string((string){.data = "\n", .length = 1}));
    print(new_string(
    ...
    print(new_string((string){.data = "to_byte(1000) = ", .length = 16}));
    print(to_string(b_trunc));
    print(
        new_string((string){.data = " (1000 mod 256 = 232)\n", .length = 22}));
    print(new_string(
        (string){.data = "\n--- Test 7: String Concatenation with Bytes ---\n",
                 .length = 49}));
    byte b5 = to_byte(65);
    string s1 = new_string((string){.data = "Value: ", .length = 7});
    ...
    print(new_string((string){.data = "Start: 42, +8 = ", .length = 16}));
    print(to_string(b7));
    print(new_string((string){.data = "\n", .length = 1}));
    print(new_string(
    ...
    print(new_string((string){.data = "Min byte: ", .length = 10}));
    print(to_string(b_zero));
    print(new_string((string){.data = ", Max byte: ", .length = 12}));
    ...
    print(new_string((string){.data = "250 + 10 = ", .length = 11}));
    print(to_string(b_add_result));
    print(new_string((string){.data = " (wraps to 4)\n", .length = 14}));
