...
void fizz_buzz_aux(int a) {
  if (a <= 100) {
    if (a % 3 == 0 && a % 5 == 0)
      print(new_string(__rock_make_string("Fizzbuzz\n", 9)));
    else if (a % 3 == 0)
      print(new_string(__rock_make_string("Fizz\n", 5)));
    else if (a % 5 == 0)
      print(new_string(__rock_make_string("Buzz\n", 5)));
    else {
      print_int(a);
