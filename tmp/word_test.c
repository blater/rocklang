...
int main(int argc, char **argv) {
  ...
  {
    word w = to_word(1000);
    print(new_string(__rock_make_string("word value: ", 12)));
    print(to_string(w));
    print(new_string(__rock_make_string("\n", 1)));
    int n = to_int(w);
    print(new_string(__rock_make_string("to_int: ", 8)));
    print(to_string(n));
    print(new_string(__rock_make_string("\n", 1)));
    word w2 = to_word(60000);
    print(new_string(__rock_make_string("to_word(60000): ", 16)));
    print(to_string(w2));
    print(new_string(__rock_make_string("\n", 1)));
    word w3 = to_word(70000);
    print(new_string(__rock_make_string("to_word(70000) truncated: ", 26)));
    print(to_string(w3));
    print(new_string(__rock_make_string("\n", 1)));
    int sum = to_int(w) + to_int(w2);
    print(new_string(__rock_make_string("1000 + 60000 = ", 15)));
    print(to_string(sum));
    print(new_string(__rock_make_string("\n", 1)));
    __internal_dynamic_array_t arr = __internal_make_array(sizeof(word), 0);
    word_push_array(arr, to_word(100));
    word_push_array(arr, to_word(200));
    word_push_array(arr, to_word(300));
    print(new_string(__rock_make_string("array length: ", 14)));
    print(to_string(length(arr)));
    print(new_string(__rock_make_string("\n", 1)));
    print(new_string(__rock_make_string("arr[1] = ", 9)));
    print(to_string(to_int(word_get_elem(arr, 1))));
    print(new_string(__rock_make_string("\n", 1)));
    int i = 42;
    print(new_string(__rock_make_string("to_string(int): ", 16)));
    print(to_string(i));
    print(new_string(__rock_make_string("\n", 1)));
    byte b = to_byte(99);
    print(new_string(__rock_make_string("to_string(byte): ", 17)));
    print(to_string(b));
    print(new_string(__rock_make_string("\n", 1)));
    print(new_string(__rock_make_string("Done\n", 5)));
  }
  kill_compiler_stack();
  return 0;
}
