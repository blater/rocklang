...
void pokeval(int address, int val);

void pokeval(int address, int val)
{byte v = to_byte(val);
word addr = to_word(address);
poke(addr, v);
byte result = peek(addr);
print(new_string(__rock_make_string("  poke(", 7)));
print(to_string(address));
print(new_string(__rock_make_string(",", 1)));
print(to_string(val));
print(new_string(__rock_make_string(")  	Expect:", 11)));
print(to_string(val));
print(new_string(__rock_make_string(", got:", 6)));
print(to_string(to_int(result)));
if (result == v)
print(new_string(__rock_make_string("   PASS", 7)));
else
print(new_string(__rock_make_string("   FAILED XXXX", 14)));
