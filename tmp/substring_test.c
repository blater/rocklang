...
int main(int argc, char **argv) {
  ...
  {
    string s = new_string(__rock_make_string("Hello World", 11));
    print(__substring_from(s, 6));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_from(s, 0));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 0, 4));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 6, 10));
    print(new_string(__rock_make_string("\n", 1)));
    int neg5 = 0 - 5;
    int neg1 = 0 - 1;
    print(__substring_from(s, neg5));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, neg5, neg1));
    print(new_string(__rock_make_string("\n", 1)));
    set_string_index_base(1);
    print(__substring_from(s, 7));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 1, 5));
    print(new_string(__rock_make_string("\n", 1)));
