...
int main(int argc, char **argv) {
  ...
  {
    print(new_string(
        (string){.data = "=== String length tests ===\n", .length = 28}));
    string s1 = new_string((string){.data = "Hello", .length = 5});
    print(new_string((string){.data = "String: ", .length = 8}));
    print(s1);
    print(new_string((string){.data = " Length: ", .length = 9}));
    print_int(length(s1));
    print(new_string((string){.data = "\n", .length = 1}));
    string s2 = new_string((string){.data = "Rock", .length = 4});
    print(new_string((string){.data = "String: ", .length = 8}));
    print(s2);
    print(new_string((string){.data = " Length: ", .length = 9}));
    print_int(length(s2));
    print(new_string((string){.data = "\n", .length = 1}));
    string s3 = new_string((string){.data = "", .length = 0});
    print(new_string((string){.data = "Empty string length: ", .length = 21}));
    print_int(length(s3));
    print(new_string((string){.data = "\n", .length = 1}));
    print(new_string(
        (string){.data = "\n=== Array length tests ===\n", .length = 28}));
    __internal_dynamic_array_t arr = __internal_make_array(sizeof(int), 0);
    print(new_string((string){.data = "Empty array length: ", .length = 20}));
    print_int(length(arr));
    print(new_string((string){.data = "\n", .length = 1}));
    int_push_array(arr, 10);
    int_push_array(arr, 20);
    int_push_array(arr, 30);
    print(new_string(
        (string){.data = "Array [10,20,30] length: ", .length = 25}));
    print_int(length(arr));
    print(new_string((string){.data = "\n", .length = 1}));
    print(new_string(
        (string){.data = "\n=== String array tests ===\n", .length = 28}));
    __internal_dynamic_array_t strs = __internal_make_array(sizeof(string), 0);
    string_push_array(strs, new_string((string){.data = "one", .length = 3}));
    string_push_array(strs, new_string((string){.data = "two", .length = 3}));
    string_push_array(strs, new_string((string){.data = "three", .length = 5}));
    print(new_string((string){.data = "String array [one,two,three] length: ",
                              .length = 37}));
    print_int(length(strs));
    print(new_string((string){.data = "\n", .length = 1}));
    print(new_string(
