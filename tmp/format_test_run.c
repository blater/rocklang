...
void fun_with_args(int a1, __internal_dynamic_array_t names);

void fun_with_args(int a1, __internal_dynamic_array_t names) {
  print(new_string(__rock_make_string("arg count: ", 11)));
  print(to_string(length(names)));
  print(new_string(__rock_make_string("\n", 1)));
  print(new_string(__rock_make_string("value: ", 7)));
  print(to_string(a1));
  print(new_string(__rock_make_string("\n", 1)));
}
...
int main(int argc, char **argv) {
  ...
  {
    print(new_string(__rock_make_string("Testing function with args\n", 27)));
    __internal_dynamic_array_t args = __internal_make_array(sizeof(string), 0);
    string_push_array(args, new_string(__rock_make_string("test1", 5)));
    string_push_array(args, new_string(__rock_make_string("test2", 5)));
    fun_with_args(42, args);
  }
  kill_compiler_stack();
  return 0;
}
