...
int main(int argc, char **argv) {
  ...
  {
    dword d = 1000000;
    print(new_string(__rock_make_string("dword value: ", 13)));
    print(to_string(d));
    ...
    print(to_string(n));
    print(new_string(__rock_make_string("\n", 1)));
    dword d2 = to_dword(2000000);
    print(new_string(__rock_make_string("to_dword(2000000): ", 19)));
    print(to_string(d2));
    print(new_string(__rock_make_string("\n", 1)));
    dword d3 = to_dword(2147483647);
    print(new_string(__rock_make_string("to_dword(2147483647): ", 22)));
    print(to_string(d3));
    print(new_string(__rock_make_string("\n", 1)));
    int sum = to_int(d) + to_int(d2);
    print(new_string(__rock_make_string("1000000 + 2000000 = ", 20)));
    print(to_string(sum));
    print(new_string(__rock_make_string("\n", 1)));
    __internal_dynamic_array_t arr = __internal_make_array(sizeof(dword), 0);
    dword_push_array(arr, to_dword(100000));
    dword_push_array(arr, to_dword(200000));
    dword_push_array(arr, to_dword(300000));
    print(new_string(__rock_make_string("array length: ", 14)));
    print(to_string(length(arr)));
    print(new_string(__rock_make_string("\n", 1)));
    print(new_string(__rock_make_string("arr[1] = ", 9)));
    print(to_string(dword_get_elem(arr, 1)));
    print(new_string(__rock_make_string("\n", 1)));
    int i = 42;
