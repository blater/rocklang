...
int main(int argc, char **argv) {
  ...
  {
    string s = new_string((string){.data = "0123456789", .length = 10});
    print(new_string(
        (string){.data = "=== 0-indexed tests ===\n", .length = 24}));
    ...
    print(new_string(
        (string){.data = "All substring tests completed successfully!\n",
                 .length = 44}));
  }
  kill_compiler_stack();
  return 0;
