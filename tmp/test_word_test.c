...
int main(int argc, char **argv) {
  ...
  {
    word w = to_word(1000);
    print(new_string((string){.data = "word value: ", .length = 12}));
    print(to_string(w));
    print(new_string((string){.data = "\n", .length = 1}));
    int n = to_int(w);
    print(new_string((string){.data = "to_int: ", .length = 8}));
    print(to_string(n));
    print(new_string((string){.data = "\n", .length = 1}));
    word w2 = to_word(60000);
    print(new_string((string){.data = "to_word(60000): ", .length = 16}));
    print(to_string(w2));
    print(new_string((string){.data = "\n", .length = 1}));
    word w3 = to_word(70000);
    print(new_string(
        (string){.data = "to_word(70000) truncated: ", .length = 26}));
    print(to_string(w3));
    print(new_string((string){.data = "\n", .length = 1}));
    int sum = to_int(w) + to_int(w2);
    print(new_string((string){.data = "1000 + 60000 = ", .length = 15}));
    print(to_string(sum));
    print(new_string((string){.data = "\n", .length = 1}));
    ...
    print(new_string((string){.data = "array length: ", .length = 14}));
    print(to_string(length(arr)));
    print(new_string((string){.data = "\n", .length = 1}));
    print(new_string((string){.data = "arr[1] = ", .length = 9}));
    print(to_string(to_int(word_get_elem(arr, 1))));
    print(new_string((string){.data = "\n", .length = 1}));
    int i = 42;
    print(new_string((string){.data = "to_string(int): ", .length = 16}));
    print(to_string(i));
    print(new_string((string){.data = "\n", .length = 1}));
    byte b = to_byte(99);
    print(new_string((string){.data = "to_string(byte): ", .length = 17}));
    print(to_string(b));
    print(new_string((string){.data = "\n", .length = 1}));
