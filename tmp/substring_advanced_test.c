...
int main(int argc, char **argv) {
  ...
  {
    string s = new_string(__rock_make_string("0123456789", 10));
    print(new_string(__rock_make_string("=== 0-indexed tests ===\n", 24)));
    print(__substring_from(s, 0));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_from(s, 5));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_from(s, 9));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 0, 2));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 3, 6));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 8, 9));
    print(new_string(__rock_make_string("\n", 1)));
    print(new_string(__rock_make_string("=== 1-indexed tests ===\n", 24)));
    set_string_index_base(1);
    print(__substring_from(s, 1));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_from(s, 6));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_from(s, 10));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 1, 3));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 4, 7));
    print(new_string(__rock_make_string("\n", 1)));
    print(__substring_range(s, 9, 10));
    print(new_string(__rock_make_string("\n", 1)));
    set_string_index_base(0);
    print(new_string(__rock_make_string(
        "All substring tests completed successfully!\n", 44)));
  }
  kill_compiler_stack();
  return 0;
}
