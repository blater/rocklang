...
int main(int argc, char **argv) {
  ...
  fill_cmd_args(argc, argv);
  {
    ...
    string_set_elem(fixed, (size_t)(0),
                    new_string((string){.data = "hello", .length = 5}));
    string_set_elem(fixed, (size_t)(1),
                    new_string((string){.data = "world", .length = 5}));
    print(new_string((string){.data = "\n-----\n", .length = 7}));
    ...
    string_push_array(strings,
                      new_string((string){.data = "Hey !\n", .length = 6}));
    string_push_array(
        strings, new_string((string){.data = "How are you ?\n", .length = 14}));
    string_push_array(strings,
                      new_string((string){.data = "What ???\n", .length = 9}));
