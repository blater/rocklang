...
int main(int argc, char **argv) {
  ...
  fill_cmd_args(argc, argv);
  {
    ...
    string s1 = __strtmp_0;
    string __strtmp_1;
    __rock_make_string(&__strtmp_1, " World", 6);
    string s2 = __strtmp_1;
    string __strtmp_2;
    __concat_str(&__strtmp_2, s1, s2);
    string result1 = __strtmp_2;
    print(result1);
    string __strtmp_3;
    __rock_make_string(&__strtmp_3, "\n", 1);
    print(__strtmp_3);
    string __strtmp_4;
    __rock_make_string(&__strtmp_4, "ABC", 3);
    string s3 = __strtmp_4;
    char c = 'D';
    string __strtmp_5;
    __concat_char(&__strtmp_5, s3, c);
    string result2 = __strtmp_5;
    print(result2);
    string __strtmp_6;
    __rock_make_string(&__strtmp_6, "\n", 1);
    print(__strtmp_6);
  }
  kill_compiler_stack();
  return 0;
